 ...
 *
 * Resolution order:
 *   1. Page path (e.g. /services/customer-chat-system) — page-aware variant
...
export interface GreetingContext {
  /** The pathname the visitor is on (e.g. "/services/customer-chat-system"). May be null on direct /chat or /embed visits. */
